...
/** Facet 深色主题 — 基于 index.css 中的 oklch 变量对应色值 */
export const facetDarkTheme: monaco.editor.IStandaloneThemeData = {
  base: 'vs-dark',
  inherit: true,
  rules: [
...
/** Facet 浅色主题 */
export const facetLightTheme: monaco.editor.IStandaloneThemeData = {
  base: 'vs',
  inherit: true,
  rules: [
